...
public interface HabitExecutionMapper {
  ...
  @Mapping(target = "successPercentage", source = "successPercentage")
  @Mapping(target = "totalExecutions", source = "totalExecutions")
  @Mapping(target = "completedExecutions", source = "completedExecutions")
  @Mapping(target = "missedExecutions", source = "missedExecutions")
  @Mapping(target = "completionsByDay", source = "completionsByDay")
